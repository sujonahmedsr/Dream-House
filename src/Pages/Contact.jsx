                ...
                <div className="grid max-w-6xl items-center grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x p-10">
                    ...
                    <form className="flex flex-col py-6 space-y-6 p-3 md:p-10 md:px-6 shadow-xl rounded-lg">
                        ...
                        <label className="block">
                            ...
                            <textarea rows="3" className="block w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 " placeholder='Type message for us'></textarea>
                        </label>
                        <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-blue-600 text-white w-full">Submit</button>
                    </form>
                </div>
            </section>
        </div>
